...
В первой строке вводится число площадей $n$ ($1≤n≤100000$).  
Во второй строке заданы $n$ чисел $a_i$ ($1≤a_i≤10^9$) — количество жителей, живущих на $i$-й площади.  
Каждая из следующих $n−1$ строк содержит пару чисел $v_j$, $u_j$ ($1≤v_j,u_j≤n$) — номера площадей, соединенных дорогой.
